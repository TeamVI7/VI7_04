...
// the inspector per weapon — no code changes needed. Class name kept as-is
// (rather than "Adapter") so existing scene/prefab references don't break.
[RequireComponent(typeof(EnemyRangedAttackBehaviour))]
public class RangedAttackTelegraphVisual : MonoBehaviour
{
    #region Inspector
